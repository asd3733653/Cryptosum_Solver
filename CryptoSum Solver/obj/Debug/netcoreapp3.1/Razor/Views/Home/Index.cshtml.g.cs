#pragma checksum "C:\Users\jacob.lee\source\repos\CryptoSum Solver\CryptoSum Solver\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e1b74b1a6285dc8dc1b590d44ffbf74c01b0c800"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e1b74b1a6285dc8dc1b590d44ffbf74c01b0c800", @"/Views/Home/Index.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e1b74b1a6285dc8dc1b590d44ffbf74c01b0c8003670", async() => {
            }
            );
...
<script>
    ...
    ");
        ...
        function solver() {
            ...
            var allsumarr");
            WriteLiteral(@" = []/*所有數值陣列*/, allsum = 0 /*所有數值總和*/, row1sum = 0 /*第1列數值總和*/, row2sum = 0/*第2列數值總和*/, row3sum = 0/*第3列數值總和*/, row4sum = 0/*第4列數值總和*/, column1sum = 0/*第1行數值總和*/, column2sum = 0/*第2行數值總和*/, column3sum = 0/*第3行數值總和*/, column4sum = 0/*第4行數值總和*/;
                        ...
                        if (arr1[j] == str1 && (9 - i) == arr1[j - 1]) {
                            switch (i) {
                                ...
                                case 3:
                                    ...
                                    remove(RemainNum, 3);
                         ");
            WriteLiteral(@"           remove(RemainEle, T3);
                                    break;
                                case 4:
                                    T4 = arr1[j + 1];//4找到了
                                    remove(RemainNum, 4);
...
");
            ...
            WriteLiteral(@"t.find(x => x == RemainEle[i]) == RemainEle[i]) {
                                elementcount++;
            ...
            function CheckArr(int1) {
                for (let i = 0; i < allarr.length; i++) {
                    ...
                    if (NowNArr.length == int1) {//找到有幾個相同的就執行
                        ...
                        switch (int1) {
                            case 2:
                                LogicComparison(allsumarr[i], NowNArr[0], NowNArr[");
            WriteLiteral(@"1], NowEArr[0], NowEArr[1]);
                                break;
                            case 3:
  ...
  ");
            WriteLiteral(@"          //邏輯比對可能的數字，如果只有一組就移除可能
       ...
       ");
            WriteLiteral(@"             remove(RemainNum, Num2);
            ...
            //取得行列數值
            function getSum() {
                row1sum = parseInt($(""input"").eq(inp");
            WriteLiteral(@"utvalue[0]).val());
            ...
            //差異邏輯
            function ");
            WriteLiteral(@"checkLogic(int1, cls1, cls2) {
                switch (int1) {
                    case 8:
                        T9 = cls1;//9找到了
                        T1 = cls2;//1找到了
        ...
        function getArrEqual(arr1, arr2) {
            ...
            for (let i = 0; i < arr2.length; i++) {
                for (let j = 0; j < arr1.length; j++) {
                    if (arr1[j] === arr2[i]) {
  ");
            WriteLiteral(@"                      newArr.push(arr1[j]);
                    }
                }
            }
            return newArr;
